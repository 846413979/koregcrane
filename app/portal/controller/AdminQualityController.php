...
class AdminQualityController extends AdminBaseController
{
    /**
     * 文章列表
     * @adminMenu(
...
//        var_dump($data->items());
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $portalPostModel->adminAddPage($data['post'], 8);


            $this->success('添加成功!', url('AdminQuality/index'));
        }
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $portalPostModel->adminEditPage($data['post'], 8);
