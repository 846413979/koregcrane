...
class AdminIntelligentCategoryController extends AdminBaseController
{
    /**
     * 文章分类列表
     * @adminMenu(
    ...
    public function index()
    {
        ...
        $categories = $portalCategoryModel->where('type',5)->where('delete_time', 0)->select();
    ...
    public function addPost()
    {
        ...
        $this->success('添加成功!', url('AdminIntelligentCategory/index'));
    }
